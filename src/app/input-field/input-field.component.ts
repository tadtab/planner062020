...
export class InputFieldComponent implements OnInit {
  ...
  onSubmit(form: NgForm){
    ...
    this.store.select('inputReducer').subscribe((value: State) => {
      ...
      this.http.post("http://ec2-54-175-142-100.compute-1.amazonaws.com:8090/plannnerSpringBoot062020-0.1.0-0.1.0/plan/save", plan).subscribe(
  ...
  getGreeted(){
    this.http.get("http://ec2-54-175-142-100.compute-1.amazonaws.com:8090/plannnerSpringBoot062020-0.1.0-0.1.0/plan/get")
    .subscribe(data => {
      this.greeting = data;
      console.log(data)})
  }
  ...
  savePlanList(plan: Plan){
      this.http.post("http://ec2-54-175-142-100.compute-1.amazonaws.com:8090/plannnerSpringBoot062020-0.1.0/plan/save", plan).subscribe(data => {
        console.log(data)
      })
  }
